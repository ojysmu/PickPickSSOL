...
object DialogFactory {
     ...
     */
    fun getTitledDialog(context: Context, @StringRes id: Int, onNeutral: () -> Unit) =
        getTitledDialog(context, context.getString(id), onNeutral)
     ...
     */
    fun getTitledDialog(context: Context, title: String, onNeutral: () -> Unit) =
     ...
     */
    fun getTitledDialog(context: Context, @StringRes id: Int, onPositive: () -> Unit, onNegative: () -> Unit) =
        getTitledDialog(context, context.getString(id), onPositive, onNegative)

    fun getTitledDialog(context: Context, title: String, onPositive: () -> Unit, onNegative: () -> Unit) =
        AlertDialog.Builder(context).apply {
            setCancelable(false)
            setTitle(title)
    ...
    fun getContentedDialog(context: Context, content: String, onNeutral: () -> Unit) =
        AlertDialog.Builder(context).apply {
            setCancelable(false)
            setMessage(content)
            setNeutralButton(R.string.common_confirm) { dialog, _ -> dialog.dismiss(); onNeutral() }
    ...
    fun getBasicDialog(context: Context, @StringRes title: Int, @StringRes message: Int, onNeutral: () -> Unit) =
        getBasicDialog(context, title, context.getString(message), onNeutral)

    fun getBasicDialog(context: Context, @StringRes title: Int, message: String, onNeutral: () -> Unit) =
        AlertDialog.Builder(context).apply {
            setCancelable(false)
            setTitle(title)
            setMessage(message)
    ...
    fun getBasicDialog(context: Context, @StringRes title: Int, @StringRes message: Int, onPositive: () -> Unit, onNegative: () -> Unit) =
        getBasicDialog(context, title, context.getString(message), onPositive, onNegative)

    fun getBasicDialog(context: Context, @StringRes title: Int, message: String, onPositive: () -> Unit, onNegative: () -> Unit) =
        AlertDialog.Builder(context).apply {
            setCancelable(false)
            setTitle(title)
            setMessage(message)
    ...
    fun getCustomDialog(
        ...
        @LayoutRes id: Int,
        init: (ViewGroup) -> Unit,
        onPositive: ((ViewGroup) -> Unit)?,
        onNegative: ((ViewGroup) -> Unit)? = {},
        onNeutral: ((ViewGroup) -> Unit)? = null
    ): AlertDialog.Builder {
